...
public interface CMM_BXJVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link CMM_BXJParser#int_array_expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitInt_array_expr(CMM_BXJParser.Int_array_exprContext ctx);
	/**
	 * Visit a parse tree produced by {@link CMM_BXJParser#double_array_expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDouble_array_expr(CMM_BXJParser.Double_array_exprContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link CMM_BXJParser#int_expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitInt_expr(CMM_BXJParser.Int_exprContext ctx);
	/**
	 * Visit a parse tree produced by {@link CMM_BXJParser#double_expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDouble_expr(CMM_BXJParser.Double_exprContext ctx);
	/**
